...
Package `0.1.0a1` was built from a fresh local clone of source revision `1c3ddbd577d9eadc830c8bb0481444de29c820b2`. `release/BUILD_INFO.json` binds the artifacts to that revision and to the complete non-release source snapshot hash.

- [x] 117 unit and regression tests passed from the source tree and from a clean sdist installation.
